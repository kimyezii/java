    ...
    public void waiting() {
        ...
        while (true) {
            ...
            if ("help".equals(cmd)) {
                ...
                CertificationSearchService search = new CertificationSearchService();
                CertificationSearchService.search();
            } else if ("add".equals(cmd)) {
                System.out.println("-------------------- 추가합니다. --------------------");
                CertificationItemWriter search = new CertificationItemWriter();
                CertificationItemWriter.add();
            }
